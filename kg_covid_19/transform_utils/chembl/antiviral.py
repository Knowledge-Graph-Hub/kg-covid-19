...
DEFAULT_MAPPING_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'chembl_antiviral_drugs_mappings.json')
...
class ChEMBLAntiviralTransform(Transform):
    ...
    def __init__(self, input_dir: str = None, output_dir: str = None, **kwargs) -> None:
    ...
    def _load_mapping_lookup(self) -> None:
        ...
        self._mapping_lookup = json.load(open(mapping_file))
