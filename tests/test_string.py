...
class TestString(TestCase):
    ...
    def test_nodes_file(self):
        ...
        self.assertEqual(
            ["id", "name", "category", "description", "xrefs", "provided_by"],
            list(node_df.columns),
        )
        self.assertCountEqual(
            [
                "ENSEMBL:ENSP00000000233",
                "ENSEMBL:ENSP00000272298",
                "ENSEMBL:ENSP00000253401",
                "ENSEMBL:ENSP00000401445",
                "ENSEMBL:ENSP00000418915",
                "ENSEMBL:ENSP00000327801",
                "ENSEMBL:ENSP00000466298",
                "ENSEMBL:ENSP00000232564",
                "ENSEMBL:ENSP00000393379",
                "ENSEMBL:ENSP00000371253",
            ],
            list(node_df.id.unique()),
        )
        self.assertEqual(
            "UniProtKB:P84085",  # isoform (-2) stripped off
            node_df.loc[node_df["id"] == "ENSEMBL:ENSP00000000233"].xrefs.item(),
        )
