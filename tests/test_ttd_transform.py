...
class TestTTD(TestCase):
    ...
    def test_parse_ttd_file_fxn(self) -> None:
        ...
        self.assertCountEqual(parsed_result.keys(), ["T47101", "T59328"])
        self.assertTrue(set(parsed_result.values()) <= set(self.abbreviations))
    ...
    def test_parse_ttd_file_values(self, target_id, abbrev, value):
        parsed_result = self.ttd.parse_ttd_file(self.ttd_dl_snippet)
        self.assertEqual(parsed_result.get(target_id).get(abbrev), value)
