...
@unittest.skip("Skipped due to issues with Ensmallen.")
class TestEdges(unittest.TestCase):
    ...
    def test_make_edges_check_edge_output_files(
        ...
        if file_should_exist:
            ...
            self.assertAlmostEqual(
                new_edges_df.shape[0], num_input_edges * expected_fract, 1
            )
    ...
    def test_make_positive_edges_check_num_train_edges_returned(self):
        ...
        self.assertTrue(
            abs(num_train_edges - expected_edges) <= 1,
    ...
    def test_make_positive_edges_check_num_test_edges_returned(self):
        ...
        self.assertTrue(
            abs(num_test_edges - expected_edges) <= 1,
    ...
    def test_make_positive_edges_check_train_edges_column_num(self):
        ...
        self.assertEqual(
            ...
            "New graph edges don't have the same number of columns" "as the original",
        )
    ...
    def test_make_positive_edges_check_train_edges_columns(self):
        ...
        self.assertListEqual(
            ...
            "New graph edges don't have the same columns" "as the original",
        )
    ...
    def test_make_positive_edges_test_repeated_edges(self):
        ...
        self.assertTrue(
            dup_rows.shape[0] == 0,
            "Got %i duplicated edges:\n%s" % (dup_rows.shape[0], dup_rows_str),
        )
    ...
    def test_make_positive_edges_test_pos_edges_are_removed_from_train_edges(self):
        ...
        self.assertEqual(
            ...
            % (overlap_test_train.shape[0], overlap_test_train.to_string()),
        )
